...
-- El historial se crea automáticamente por hook al registrar un usuario,
-- pero para los datos demo lo insertamos a mano.
INSERT INTO historial_medico (usuario_id, alergias, enfermedades, medicamentos, grupo_sanguineo)
VALUES
  (1, 'Penicilina', 'Hipertensión, Alzheimer leve', 'Losartán 50mg c/12h, Donepezilo 5mg c/24h', 'O+');
...
VALUES
  (1, -12.0972400, -77.0364200, 12, 0),
  (1, -12.0972500, -77.0364300, 10, 0);
